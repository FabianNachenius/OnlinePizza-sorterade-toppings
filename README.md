# OnlinePizza-sorterade-toppings
Detta script sorterar tillvalen (toppings / ingredienser) på Foodora (tidigare Onlinepizza) och kan köras i webbläsaren med hjälp av t.ex. TamperMonkey.
